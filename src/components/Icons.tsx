...
export const WorkingIcon: React.FC<IIconProps> = ({ className = "" }) => (
    <svg
...
export const SearchIcon: React.FC<IIconProps> = ({ className = "" }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="currentColor"
...
export const EyeIcon: React.FC<IIconProps> = ({ className = "" }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="currentColor"
